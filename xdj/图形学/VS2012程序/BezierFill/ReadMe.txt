================================================================================
    MICROSOFT 基础类库： BezierFill 项目概述
===============================================================================

应用程序向导已为您创建了此 BezierFill 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 BezierFill 应用程序的每个文件的内容摘要。
...
BezierFill.h
    ...
    CBezierFillApp 应用程序类。

BezierFill.cpp
    这是包含应用程序
    类 CBezierFillApp 的主应用程序源文件。
...
res\Toolbar.bmp
    ...
    更新 BezierFill.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导将创建一种文档类型和一个视图：

BezierFillDoc.h、BezierFillDoc.cpp - 文档
    这些文件包含 CBezierFillDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CBezierFillDoc::Serialize）。
BezierFillView.h、BezierFillView.cpp - 文档视图
    这些文件包含 CBezierFillView 类。
    CBezierFillView 对象用于查看 CBezierFillDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 BezierFill.pch 的预编译头文件 (PCH)
