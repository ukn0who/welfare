================================================================================
    MICROSOFT 基础类库： MidPointEllipse 项目概述
===============================================================================

应用程序向导已为您创建了此 MidPointEllipse 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 MidPointEllipse 应用程序的每个文件的内容摘要。
...
MidPointEllipse.h
    ...
    CMidPointEllipseApp 应用程序类。

MidPointEllipse.cpp
    这是包含应用程序
    类 CMidPointEllipseApp 的主应用程序源文件。
...
res\MidPointEllipse.ico
    这是一个图标文件，用作应用程序的图标。  此
    图标包含在主资源文件 MidPointEllipse.rc 中。

res\MidPointEllipse.rc2
    此文件包含不由 Microsoft 
...
res\Toolbar.bmp
    ...
    更新 MidPointEllipse.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导将创建一种文档类型和一个视图：

MidPointEllipseDoc.h、MidPointEllipseDoc.cpp - 文档
    这些文件包含 CMidPointEllipseDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CMidPointEllipseDoc::Serialize）。
MidPointEllipseView.h、MidPointEllipseView.cpp - 文档视图
    这些文件包含 CMidPointEllipseView 类。
    CMidPointEllipseView 对象用于查看 CMidPointEllipseDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 MidPointEllipse.pch 的预编译头文件 (PCH)
