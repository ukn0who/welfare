================================================================================
    MICROSOFT 基础类库： Bresenham_Line 项目概述
===============================================================================

应用程序向导已为您创建了此 Bresenham_Line 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 Bresenham_Line 应用程序的每个文件的内容摘要。
...
Bresenham_Line.h
    ...
    CBresenham_LineApp 应用程序类。

Bresenham_Line.cpp
    这是包含应用程序
    类 CBresenham_LineApp 的主应用程序源文件。
...
res\Bresenham_Line.ico
    这是一个图标文件，用作应用程序的图标。  此
    图标包含在主资源文件 Bresenham_Line.rc 中。

res\Bresenham_Line.rc2
    此文件包含不由 Microsoft 
...
res\Toolbar.bmp
    ...
    更新 Bresenham_Line.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导将创建一种文档类型和一个视图：

Bresenham_LineDoc.h、Bresenham_LineDoc.cpp - 文档
    这些文件包含 CBresenham_LineDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CBresenham_LineDoc::Serialize）。
Bresenham_LineView.h、Bresenham_LineView.cpp - 文档视图
    这些文件包含 CBresenham_LineView 类。
    CBresenham_LineView 对象用于查看 CBresenham_LineDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 Bresenham_Line.pch 的预编译头文件 (PCH)
