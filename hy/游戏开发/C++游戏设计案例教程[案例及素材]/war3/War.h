...
/*定义精灵*/
Sprite * g_pSprCharStateL;
Sprite * g_pSprCharStateR;
Sprite * g_pSprWarBarTop;
Sprite * g_pGirlSmall;
Sprite * g_pFoemanSmall;
Sprite * g_pGirlSpeed;
Sprite * g_pFoemanSpeed;

int g_nGirlSpeedX,g_nFoemanSpeedX;	//速度小人的水平位置